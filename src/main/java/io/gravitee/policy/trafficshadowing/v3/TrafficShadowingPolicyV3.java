...
import io.gravitee.policy.trafficshadowing.v3.invoker.ShadowInvoker;

/**
 * @author David BRASSELY (david.brassely at graviteesource.com)
 * @author GraviteeSource Team
 */
public class TrafficShadowingPolicyV3 {

    protected final TrafficShadowingPolicyConfiguration configuration;

    public TrafficShadowingPolicyV3(final TrafficShadowingPolicyConfiguration configuration) {
